#!/usr/bin/env python3
"""Run fixed-order stock/direct/native clock/timestamp CPU samples."""
...
WORKER = HERE / "clock_benchmark_worker.py"
...
def _arguments(argv=None):
    ...
    parser.add_argument(
        "--output",
        type=Path,
        default=REPO_ROOT / "build" / "clock-characterization.json",
    )
...
def _print_summary(document, output):
    print("clock/timestamp CPU characterization (claims disabled)")
