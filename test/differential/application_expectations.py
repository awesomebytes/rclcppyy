...
APPLICATION_PARITY = (
    ...
    ParityExpectation("qos.resolved", ("resolved_qos",),
                      "Complete endpoint QoS and non-empty overrides match stock."),
    ...
    ParityExpectation("qos.events_matched", ("qos_matched_events",),
                      "Active matched event callbacks and teardown match stock."),
    ...
    ParityExpectation("lifecycle.error_processing", ("lifecycle_error_processing",),
                      "ERROR returns, callback exceptions, and on_error recovery match stock."),
    ParityExpectation("lifecycle.invalid_transitions", ("lifecycle_invalid_transitions",),
                      "Invalid lifecycle transition exception types and messages match stock."),
    ParityExpectation("lifecycle.shutdown_origins", ("lifecycle_shutdown_origins",),
                      "Shutdown from inactive and active states matches stock."),
